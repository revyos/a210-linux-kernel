...
#else
#ifndef CONFIG_ARCH_ZHIHE
#define KERN_VIRT_SIZE          (ulong)((PTRS_PER_PGD / 2 * PGDIR_SIZE) / 2)
#else
/* 128G(0x20_0000_0000) -> 160G(0x28_0000_0000) */
#define KERN_VIRT_SIZE          (ulong)(0x2800000000ul)
#endif /* CONFIG_ARCH_ZHIHE */
#endif

#ifndef CONFIG_ARCH_ZHIHE
#define VMALLOC_SIZE     (KERN_VIRT_SIZE >> 1)
#else
#define VMALLOC_SIZE     (55ul << 30)
#endif /* CONFIG_ARCH_ZHIHE */

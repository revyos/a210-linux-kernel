		      ...
		      const char *vmlinux, bool vmlinux_allocated)
{
	...
	if (symsrc__init(&ss, dso, symfs_vmlinux, symtab_type)) {
		// free this buffer here according to newest code
		// https://elixir.bootlin.com/linux/v6.15-rc7/source/tools/perf/util/symbol.c#L1997
...
int dso__load_vmlinux_path(struct dso *dso, struct map *map)
{
	...
	if (filename != NULL) {
		...
		if (err > 0)
			goto out;
		// delete this line according to newest code
		// https://elixir.bootlin.com/linux/v6.15-rc7/source/tools/perf/util/symbol.c#L2042
		//free(filename);
	}
out:
	return err;
...
static int dso__load_kernel_sym(struct dso *dso, struct map *map)
{
	...
	if (filename != NULL) {
		...
		if (err > 0)
			return err;
		// delete this line according to newest code
		// https://elixir.bootlin.com/linux/v6.15-rc7/source/tools/perf/util/symbol.c#L2171
		//free(filename);
	}

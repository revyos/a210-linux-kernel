...
enum {
	ZHIHE_A200 = 0,
	ZHIHE_A210 = 1,
	ZHIHE_BOARD_DEFAULT = ZHIHE_A200,
};

#define I2S_MASTER		1
#define I2S_SLAVE		0

#define DIV0_DEFAULT		1
#define DIV3_DEFAULT		3
...
#define ZHIHE_I2S_BIT_WIDTH	32
#define ZHIHE_I2S_REG_STRIDE	4
#define ZHIHE_I2S_DMA_MAX_BURST	4
#define ZHIHE_I2S_DMA_FIX_BURST	1

#define I2S_DMA_TX_THRESHOLD	16
#define I2S_DMA_RX_THRESHOLD	16

#define ZHIHE_I2S_RATES		SNDRV_PCM_RATE_8000_384000
#define ZHIHE_I2S_FMTS		(SNDRV_PCM_FMTBIT_FLOAT_LE | \
				 SNDRV_PCM_FMTBIT_S32_LE | \
				 SNDRV_PCM_FMTBIT_S24_LE | \
				 SNDRV_PCM_FMTBIT_S16_LE | \
				 SNDRV_PCM_FMTBIT_S8)
#define ZHIHE_I2S_HDMI_FMTS	(SNDRV_PCM_FMTBIT_S24_LE | \
				 SNDRV_PCM_FMTBIT_S16_LE)
...
#define ZHIHE_IIS_48000_SRC_CLK	294912000
#define	ZHIHE_IIS_44100_SRC_CLK	316108800

#define IIS_MCLK_SEL_256	256
#define IIS_MCLK_SEL_384	384
...
#define I2S_DR0		0x04C /* CH0_Data Register */
...
#define CNFIN_RSAFS_RJ			(0x1U << CNFIN_RSAFS_Pos)
#define CNFIN_RSAFS_LJ			(0x2U << CNFIN_RSAFS_Pos)
...
#define CNFOUT_TSAFS_MSK		(0x3U << CNFOUT_TSAFS_POS)
#define CNFOUT_TSAFS_I2S		(0x0U << CNFOUT_TSAFS_POS)
#define CNFOUT_TSAFS_RJ			(0x1U << CNFOUT_TSAFS_POS)
#define CNFOUT_TSAFS_LJ			(0x2U << CNFOUT_TSAFS_POS)
#define CNFOUT_TSAFS_PCM		(0x3U << CNFOUT_TSAFS_POS)

#define CNFOUT_TALOLRC_Pos		(2U)
#define CNFOUT_TALOLRC_Msk		(0x1U << CNFOUT_TALOLRC_Pos)
#define CNFOUT_TALOLRC_HIGHFORLEFT	CNFOUT_TALOLRC_Msk

#define CNFOUT_TX_VOICE_EN_Pos		(3U)
#define CNFOUT_TX_VOICE_EN_Msk		(0x1U << CNFOUT_TX_VOICE_EN_Pos)
#define CNFOUT_TX_VOICE_EN_MONO		CNFOUT_TX_VOICE_EN_Msk

#define CNFOUT_I2S_TXMODE_Pos		(4U)
#define CNFOUT_I2S_TXMODE_Msk		(0x1U << CNFOUT_I2S_TXMODE_Pos)
#define CNFOUT_I2S_TXMODE_SLAVE		CNFOUT_I2S_TXMODE_Msk

#define CNFOUT_TX_CLK_SEL_Pos		(5U)
#define CNFOUT_TX_CLK_SEL_Msk		(0x1U << CNFOUT_TX_CLK_SEL_Pos)
#define CNFOUT_TX_CLK_SEL_MCLK		CNFOUT_TX_CLK_SEL_Msk
...
struct zhihe_i2s_soc_drvdata {
	...
	char hdmi_dai_name[32];
	unsigned int tx_dr;
	unsigned int rx_dr;
};

struct zhihe_i2s_priv {
	struct clk *pclk;
	struct clk *sclk;
	struct device *dev;
	...
	const struct zhihe_i2s_soc_drvdata *drvdata;

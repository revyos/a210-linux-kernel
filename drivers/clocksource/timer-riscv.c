...
static long *xuantie_timer_smode_base = NULL;
...
#define NR_HARTS_PER_DIE CONFIG_NR_HARTS_PER_DIE
static void xuantie_sstc_set_timer(u64 next_tval)
{
	...
	if (!xuantie_timer_smode_base)
		return sbi_set_timer(next_tval);

	/* clint timer, shadow register */
	hartid %= NR_HARTS_PER_DIE;
